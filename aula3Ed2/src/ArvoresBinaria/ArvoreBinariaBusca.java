...
public class ArvoreBinariaBusca {
	...
	public String imprimirPreOrdem() {
        return imprimirPreOrdemRecursivo(raiz);
    }

    private String imprimirPreOrdemRecursivo(No noReferencia) {
        if (noReferencia != null) {
            System.out.print(noReferencia.getValor() + " ");
            imprimirPreOrdemRecursivo(noReferencia.getEsquerdo());
            imprimirPreOrdemRecursivo(noReferencia.getDireito());
        }
		return null;
    }
    
    String imprimirInOrdem() {
        return imprimirInOrdemRecursivo(raiz);
    }

    String imprimirInOrdemRecursivo(No noReferencia) {
        if (noReferencia != null) {
            imprimirInOrdemRecursivo(noReferencia.getEsquerdo());
            System.out.print(noReferencia.getValor() + " ");
            imprimirInOrdemRecursivo(noReferencia.getDireito());
        }
		return null;
    }
    ...
    public String imprimirPosOrdem() {
        if (raiz == null) {
            ...
            imprimirPosOrdemRecursivamente(raiz, sb);
            return sb.toString().trim();
        }
    }

    private void imprimirPosOrdemRecursivamente(No noReferencia, StringBuilder sb) {
        if (noReferencia != null) {
            imprimirPosOrdemRecursivamente(noReferencia.getEsquerdo(), sb);
            imprimirPosOrdemRecursivamente(noReferencia.getDireito(), sb);
            sb.append(noReferencia.getValor()).append(" ");
        }
    }
