...
class ArvoreBinariaTest {
	...
	@Test
	public void testIsZigZag() {
		ArvoreBinariaBusca arvore1 = new ArvoreBinariaBusca();
		// Uma árvore vazia é considerada um zigzag
		assertTrue(arvore1.isZigZag());

		ArvoreBinariaBusca arvore2 = new ArvoreBinariaBusca();
		arvore2.adicionaNo(2);
		// Uma árvore com apenas um nó também é um zigzag
		assertTrue(arvore2.isZigZag());

		ArvoreBinariaBusca arvore3 = new ArvoreBinariaBusca();
		arvore3.adicionaNo(2);
		arvore3.adicionaNo(1);
		// Árvore com dois nós, onde o segundo é menor que o primeiro
		assertTrue(arvore3.isZigZag());

		ArvoreBinariaBusca arvore4 = new ArvoreBinariaBusca();
		arvore4.adicionaNo(2);
		arvore4.adicionaNo(3);
		// Árvore com dois nós, onde o segundo é maior que o primeiro
		assertTrue(arvore4.isZigZag());

		ArvoreBinariaBusca arvore5 = new ArvoreBinariaBusca();
		arvore5.adicionaNo(2);
		arvore5.adicionaNo(1);
		arvore5.adicionaNo(3);
		// Árvore com três nós, onde o primeiro é menor, o segundo é maior e o terceiro
		// é menor
		assertTrue(arvore5.isZigZag());

		ArvoreBinariaBusca arvore6 = new ArvoreBinariaBusca();
		arvore6.adicionaNo(2);
		arvore6.adicionaNo(3);
		arvore6.adicionaNo(1);
		// Árvore com três nós, onde o primeiro é maior, o segundo é menor e o terceiro
		// é maior
		assertFalse(arvore6.isZigZag());

		ArvoreBinariaBusca arvore7 = new ArvoreBinariaBusca();
		arvore7.adicionaNo(2);
		arvore7.adicionaNo(1);
		arvore7.adicionaNo(3);
		arvore7.adicionaNo(4);
		// Árvore com quatro nós, que segue a propriedade zigzag
		assertTrue(arvore7.isZigZag());

		ArvoreBinariaBusca arvore8 = new ArvoreBinariaBusca();
		arvore8.adicionaNo(2);
		arvore8.adicionaNo(1);
		arvore8.adicionaNo(3);
		arvore8.adicionaNo(4);
		arvore8.adicionaNo(0);
		// Árvore com cinco nós, que não segue a propriedade zigzag
		assertFalse(arvore8.isZigZag());
	}
